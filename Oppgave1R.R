...
####### får opp denne feilmeldingen 
# Error in open.connection(4L, "rb") : 
#Timeout was reached: [vortex.nsstc.uah.edu] Resolving timed out after 10000 milliseconds
#så får vi ikke fullført siste på oppgave 2 for å se om det virker
#velger å levere da tiden går, har denne error siden kl 10 idag,
#får prøve den senere når man får kontakten igjen, er ikke bare meg,
#men flere som får samme feilmelding under avlesning av url.
